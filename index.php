...
<?php
	...
	$coffees = $conn->query("SELECT * FROM products WHERE type='coffee'");
	$coffees->execute();

	$allCoffees = $coffees->fetchAll(PDO::FETCH_OBJ);
...
?>
    ...
    <section class="ftco-section">
    	<div class="container">
        	...
        	<div class="row">
				<?php foreach($allCoffees as $coffee) : ?>
        		<div class="col-md-3">
        			<div class="menu-entry">
    					<a target="_blank" href="products/product-single.php?id=<?php echo $coffee->id; ?>" class="img" style="background-image: url(<?php echo APPURL; ?>/images/<?php echo $coffee->image; ?>"></a>
    					<div class="text text-center pt-4">
    						<h3><a target="_blank" href="products/product-single.php?id=<?php echo $coffee->id; ?>"><?php echo $coffee->name; ?></a></h3>
    						<p><?php echo $coffee->description; ?></p>
    						<p class="price"><span>$<?php echo $coffee->price; ?></span></p>
    						<p><a target="_blank" href="products/product-single.php?id=<?php echo $coffee->id; ?>" class="btn btn-primary btn-outline-primary">Show</a></p>
    					</div>
    				</div>
        		</div>
				<?php endforeach; ?>
